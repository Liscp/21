      ...
      if (!this.state.perdiste) {
        if (this.state.apuestaActual) {
          ...
          if (jugador.contar > 21) {
            this.setState({ jugador, perdiste: true, mensaje: 'Destrozado!' });
          } else {
            this.setState({ baraja: actualizarMazo, jugador });
          }
        } else {
          this.setState({ mensaje: 'Please place bet.' });
        }
      } else {
        this.setState({ mensaje: 'Game over! Please start a new game.' });
      }
    }
      ...
      return (
        <div>
          ...
          <div className="buttons">
            ...
            <button onClick={() => {this.pedirCarta()}}>Pedir Carta</button>
          </div>
          
          <p>Cartera: ${ this.state.cartera }</p>
          {
          ...
          <p>Tu mano ({ this.state.jugador.contar })</p>
          ...
          <p>Mano Oponente ({ this.state.repartidor.contar })</p>
          <table className="cards">
            <tr>
